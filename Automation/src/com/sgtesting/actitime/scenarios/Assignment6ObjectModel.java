...
public class Assignment6ObjectModel  {
	...
	public static Logger log=Logger.getLogger("Automation Assignment6");
	...
	public void launchBrowser()  
	{
		try
		{
			...
			log.info("The Browser has launched successfully in Assignment6");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void navigate()
	{
		try
		{
			...
			log.info("The ActiTime page has navigated successfully in Assignment6");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void minimizeFlyOutWindow()
	{
		try
		{
			...
			log.info("The ActiTime page FlyOutWindow has Minimized  in Assignment6");
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();		
	...
	public void createcustomer(String Customername)
	{
		try
		{
			...
			Thread.sleep(1000);
			log.info("The ActiTime page has Created Customer successfully in Assignment5");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	@Test(priority=6,dataProvider="createProject1Credentials")
	public void createproject(String Projectname)
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("giveProjectnameonCustomer1")).sendKeys(Projectname);
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("giveconfirmProjectnameonCustomer1")).click();
			log.info("The ActiTime page has Created Project successfully in Assignment5");
	...
	@Test(priority=7,dataProvider="modifyProject1Credentials")
	public void modifyproject(String ModifyProject)
	{
		try
		{
			log.info(path);
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("selectnamefieldtomofiyProjectinCustomer1")).click();   
			Thread.sleep(2500);
			oBrowser.findElement(objectmap.getLocator("selecttoEnternamefieldtomodifyProjectinCustomer1")).clear();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("selecttoEnternamefieldtomodifyProjectinCustomer1")).sendKeys(ModifyProject);
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("selecttoDescriptiontomodifyProjectinCustomer1")).click();
			Thread.sleep(1000);
			//oBrowser.findElement(objectmap.getLocator("selectsettingbuttontomodifyprojectofCustomer1")).click();
			oBrowser.findElement(objectmap.getLocator("selectclosetomodifyprojectinCustomer1")).click();
			log.info("The ActiTime page has Modified Project successfully in Assignment6");
			Thread.sleep(1000);
	...
	public void deleteproject()
	{
		try
		{
			...
			log.info("The ActiTime page has Deleted Project successfully in Assignment6");
			Thread.sleep(1000);
	...
	public void deletecustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			log.info("The ActiTime page has Deleted Customer successfully in Assignment6");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void logout()
	{
		try
		{
			...
			Thread.sleep(2000);
			log.info("The ActiTime page has Logout successfully in Assignment6");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void closeApplication()
	{
		try
		{
			log.info(path);
			oBrowser.quit();
			log.info("The ActiTime page has closed Application Sucessfully in Assignment6");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	@DataProvider(name="createProject1Credentials")
	public Object[][] getcreateProjectCredentials()
	{
		return new Object[][]{
			{"Project1"}
			};
	}
	@DataProvider(name="modifyProject1Credentials")
	public Object[][] getmodifyProjectCredentials()
	{
		return new Object[][]{
			{"Project 303"}
			};
