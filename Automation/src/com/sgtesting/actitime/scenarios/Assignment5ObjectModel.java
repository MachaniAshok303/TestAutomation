...
public class Assignment5ObjectModel {
	...
	public static Logger log=Logger.getLogger("Automation Assignment5");
	...
	public void launchBrowser()  
	{
		try
		{
			...
			log.info("The Browser has launched successfully in Assignment5");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void navigate()
	{
		try
		{
			...
			log.info("The ActiTime page has navigated successfully in Assignment5");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void minimizeFlyOutWindow()
	{
		try
		{
			...
			Thread.sleep(2000);
			log.info("The ActiTime page FlyOutWindow has Minimized  in Assignment5");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void deleteproject()
	{
		try
		{
			...
			log.info("The ActiTime page has Deleted Project successfully in Assignment5");
			Thread.sleep(1000);
	...
	public void deletecustomer()
	{
		try
		{
			...
			log.info("The ActiTime page has Deleted Customer successfully in Assignment5");
			Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();		
	...
	public void logout()
	{
		try
		{
			...
			Thread.sleep(2000);
			log.info("The ActiTime page has Logout successfully in Assignment5");
		}catch(Exception e)
		{
			e.printStackTrace();	
	...
	public void closeApplication()
	{
		try
		{
			log.info(path);
			oBrowser.quit();
			log.info("The ActiTime page has closed Application Sucessfully in Assignment5");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
