...
public class Assignment7ObjectModel {
	...
	public static Logger log=Logger.getLogger("Automation Assignment7");
	...
	public void navigate()
	{
		try
		{
			...
			log.info("The ActiTime page has navigated successfully in Assignment7");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void minimizeFlyOutWindow()
	{
		try
		{
			...
			log.info("The ActiTime page FlyOutWindow has Minimized  in Assignment7");
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();		
	...
	public void createcustomer(String Customername)
	{
		try
		{
			...
			Thread.sleep(1000);
			log.info("The ActiTime page has Created Customer successfully in Assignment6");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void createproject(String Projectname)
	{
		try
		{
			...
			log.info("The ActiTime page has Create Project successfully in Assignment7");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	@Test(priority=7,dataProvider="createTask1Credentials")
	public void createTask(String Task1)
	{
		try
		{
			log.info(path);
			...
			Thread.sleep(4000);
			log.info("The ActiTime page has Create Task successfully in Assignment7");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void deleteTask()
	{
		try
		{
			...
			Thread.sleep(4000);
			log.info("The ActiTime page has Deleted Task successfully in Assignment7");
	...
	public void deleteproject()
	{
		try
		{
			...
			Thread.sleep(1000);
			log.info("The ActiTime page has Deleted Project successfully in Assignment7");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void deletecustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			log.info("The ActiTime page has Deleted Customer successfully in Assignment7");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	public void logout()
	{
		try
		{
			...
			log.info("The ActiTime page Admin has Logout Application Sucessfully in Assignment7");
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();		
	...
	public void closeApplication()
	{
		try
		{
			log.info(path);
			oBrowser.quit();
			log.info("The ActiTime page has closed Application Sucessfully in Assignment7");
		}catch(Exception e)
		{
			e.printStackTrace();		
		}
	...
	@DataProvider(name="createTask1Credentials")
	public Object[][] getcreateTask1Credentials()
	{
		return new Object[][]{
			{"Task1"}
			};
