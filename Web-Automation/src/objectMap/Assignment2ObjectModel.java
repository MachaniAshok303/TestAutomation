...
public class Assignment2ObjectModel {
	...
	static void modifyUser1()
	{
		try
		{
			...
			Thread.sleep(2500);
			/*oBrowser.findElement(objectmap.getLocator("giveFirstnameofUser1")).clear();
			oBrowser.findElement(objectmap.getLocator("giveFirstnameofUser1")).sendKeys("User2");
			oBrowser.findElement(objectmap.getLocator("giveLastnameofUser1")).clear();
			oBrowser.findElement(objectmap.getLocator("giveLastnameofUser1")).sendKeys("demo2");
			Thread.sleep(1500);
			oBrowser.findElement(objectmap.getLocator("giveEmailofUser1")).clear();
			oBrowser.findElement(objectmap.getLocator("giveEmailofUser1")).sendKeys("User2@gmail.com");
			oBrowser.findElement(objectmap.getLocator("giveUsernmaeofUser1")).clear();
			oBrowser.findElement(objectmap.getLocator("giveUsernmaeofUser1")).sendKeys("USER2");
			oBrowser.findElement(objectmap.getLocator("givePasswordofUser1")).clear();
			Thread.sleep(1500);*/
			oBrowser.findElement(objectmap.getLocator("givePasswordofUser1")).sendKeys("12345");
			oBrowser.findElement(objectmap.getLocator("giveConfirmPasswordofUser1")).clear();
			oBrowser.findElement(objectmap.getLocator("giveConfirmPasswordofUser1")).sendKeys("12345");
			Thread.sleep(1500);
